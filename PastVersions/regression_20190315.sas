...
proc logistic data=reg1 out=DRNOC.reg1_oud_no_cancer;
  class binary_race binary_sex binary_hispanic AGEGRP1 eventyear;
...
proc glimmix data=reg2;
  class binary_race binary_sex binary_hispanic agegrp1 eventyear PROVIDERID;
...
proc logistic data=DMLocal.opioid_flat_model_exc_cancer out=DRNOC.reg8_overdose;
  class binary_race binary_sex binary_hispanic AGEGRP1 eventyear;
...
proc logistic data=DMLocal.opioid_flat_model_exc_cancer out=DRNOC.reg9_fatal_overdose;
  class binary_race binary_sex binary_hispanic AGEGRP1 eventyear;
...
proc logistic data=DMLocal.opioid_flat_model_exc_cancer out=DRNOC.reg10_smoking;
  class binary_race binary_sex binary_hispanic AGEGRP1 eventyear;
