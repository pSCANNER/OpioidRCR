...
** Amy changed sum(enrolled) for n back to count(*) 9/16/19, which is equivalent to sum(ANY_ENC_CY) **;
proc sql noprint;
...
select "Eventyear x State" as Type length=50, eventyear, state,
"" as facility_location length=3, "" as race length=2, "" as sex length=2, "" as hispanic length=2, "" as AGEGRP1 length=5,
count(*) as n "total number of the observations", 
nmiss(&var) as nm_&var "number of the missing values in &var",
sum(&var) as n_&var "total number of positive values in &var",
sum(&var)/(count(*)-nmiss(&var)) as r_&var "Rate of &var"
...
select "Eventyear x Race" as Type length=50, eventyear, race,
"" as facility_location length=3, "" as state length=2, "" as sex length=2, "" as hispanic length=2, "" as AGEGRP1 length=5,
count(*) as n "total number of the observations",
nmiss(&var) as nm_&var "number of the missing values in &var",
sum(&var) as n_&var "total number of positive values in &var",
sum(&var)/(count(*)-nmiss(&var)) as r_&var "Rate of &var"
...
select "Eventyear x Sex" as Type length=50, eventyear, sex,
"" as facility_location length=3, "" as state length=2, "" as race length=2, "" as hispanic length=2, "" as AGEGRP1 length=5,
count(*) as n "total number of the observations",
nmiss(&var) as nm_&var "number of the missing values in &var",
sum(&var) as n_&var "total number of positive values in &var",
sum(&var)/(count(*)-nmiss(&var)) as r_&var "Rate of &var"
...
select "Eventyear x Hispanic" as Type length=50, eventyear, hispanic,
"" as facility_location length=3, "" as state length=2, "" as race length=2, "" as sex length=2, "" as AGEGRP1 length=5,
count(*) as n "total number of the observations",
nmiss(&var) as nm_&var "number of the missing values in &var",
sum(&var) as n_&var "total number of positive values in &var",
sum(&var)/(count(*)-nmiss(&var)) as r_&var "Rate of &var"
...
select "Eventyear x Agegrp1" as Type length=50, eventyear, AGEGRP1,
"" as facility_location length=3, "" as state length=2, "" as race length=2, "" as sex length=2, "" as hispanic length=2,
count(*) as n "total number of the observations",
nmiss(&var) as nm_&var "number of the missing values in &var",
sum(&var) as n_&var "total number of positive values in &var",
sum(&var)/(count(*)-nmiss(&var)) as r_&var "Rate of &var"
...
select "Eventyear" as Type length=50, eventyear,
"" as facility_location length=3, "" as state length=2, "" as race length=2, "" as sex length=2, "" as hispanic length=2, "" as AGEGRP1 length=5,
count(*) as n "total number of the observations", 
nmiss(&var) as nm_&var "number of the missing values in &var",
sum(&var) as n_&var "total number of positive values in &var",
sum(&var)/(count(*)-nmiss(&var)) as r_&var "Rate of &var"
